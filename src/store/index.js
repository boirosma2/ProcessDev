...
export default new Vuex.Store({
      ...
      1.0: {
        template: {
          ...
          */
          ...
          '{{Description code tarifaire}}': `Fiches de formations.0."Description code tarifaire"`,
  ...
  getters: {
    ...
    /* currentPfa: (state, getters) => valueJoinWithSheetCodeTarifaire => {
      const sheetFichePfa = getters.currentMapping.nameSheetPFA

      const formation = {}
      formation[sheetFichePfa] = {
        '0': state.data[sheetFichePfa].filter(obj => obj[valueColumnJoinWithSheetDetailsFormation] === valueJoinWithSheetCodeTarifaire)
      }
      return formation
    }, */
